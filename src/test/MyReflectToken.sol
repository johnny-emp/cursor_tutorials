...
contract MyReflectToken is AbstractReflectToken {
    constructor(address owner, uint256 initialSupply, address taxAddress, uint256 buyTax, uint256 sellTax, uint256 percentToReflect) AbstractReflectToken("My Reflect Token", "MRT", buyTax, sellTax, taxAddress, percentToReflect) {
